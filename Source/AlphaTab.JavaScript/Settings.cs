...
namespace AlphaTab
{
    ...
    {
        public void LoadFromJson(object settings)
        {

        }

        public void LoadFromPropertyBag(FastDictionary<string, object> settings)
        {
        }

        public FastDictionary<string, object> ToPropertyBag()
        {
            return null;
        }
...
//            if (settings.DisplayMode == NotationMode.SongBook)
//            {
...
//
//
//        private static NotationMode DecodeDisplayMode(object mode)
//        {
//            if (Platform.Platform.TypeOf(mode) == "number")
//            {
//                return (NotationMode)mode;
//            }
//
...
//                {
//                    case "songbook":
//                        return NotationMode.SongBook;
//                    case "guitarpro":
//                        return NotationMode.GuitarPro;
//                }
//            }
//
//            return NotationMode.GuitarPro;
